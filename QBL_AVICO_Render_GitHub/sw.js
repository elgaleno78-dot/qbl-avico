const CACHE='qbl-avico-v16-acordeon-compactosponsive-v10-private';
const ASSETS=['./','./index.html','./manifest.webmanifest','./icons/icon-192.png','./icons/icon-512.png','./avico-wallpaper.webp'];
