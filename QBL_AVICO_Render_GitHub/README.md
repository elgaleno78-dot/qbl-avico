...
## v15 — Acordeón accesible
Cada sección se puede abrir/cerrar. Al abrir una pestaña, las demás se cierran automáticamente. Se simplificaron varios títulos y términos para una interfaz más clara, sin cambiar la lógica clínica ni los cálculos.


## v16 — Acordeón compacto
Todas las secciones inician cerradas. Al tocar una, se despliega y las demás se cierran automáticamente. Se añadieron subtítulos breves para orientar al usuario y reducir la extensión visual, especialmente en celular.
